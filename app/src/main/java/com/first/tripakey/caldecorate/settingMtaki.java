...
public class settingMtaki extends ActionBarActivity {
    //ตั้งตามสูตรต้อม
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_mtaki);
        ...
        noChe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.commit();
                startActivity(new Intent(settingMtaki.this, calcurtainMtaki.class));
            }
        });
        ...
        chn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((!edt_E.getText().toString().trim().isEmpty())&&
                    ...
                    startActivity(new Intent(settingMtaki.this, calcurtainMtaki.class));//กลับไปหน้าคำนวน
                }
