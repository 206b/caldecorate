...
public class CalCurtain extends ActionBarActivity {
...
///////จบ2 copy แอดส่วนลดตาม
        ...
        setTitle(R.string.calcurtain);
         setContentView(R.layout.activity_cal_curtain);
    ...
    ////        public void onClick(View v) {
     //           startActivity(new Intent(CalCurtain.this, setting.class));
     //       }
     //   });
    ...
    public void onBackPressed() {
        startActivity(new Intent(CalCurtain.this, curtain.class));
        double_fabW = 0.0;
        double_priceInt =0.0;
        double_doorW =0.0;
        double_doorH =0.0;
