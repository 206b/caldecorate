...
public class costManbapsang extends ActionBarActivity {
//////เริ่ม1 copy แอดส่วนลดตาม
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cost_manbapsang);
...
////add inflater of fabtotal
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(costManbapsang.this, calcost.class));
