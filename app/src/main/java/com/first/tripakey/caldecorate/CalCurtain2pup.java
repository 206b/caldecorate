...
public class CalCurtain2pup extends ActionBarActivity {
...
///////จบ2 copy แอดส่วนลดตาม
        ...
        setTitle(R.string.calcurtain2pup);

        setContentView(R.layout.activity_cal_curtain2pup);
    ...
    public void onBackPressed() {
        startActivity(new Intent(CalCurtain2pup.this, curtain.class));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_settings:
                startActivity(new Intent(CalCurtain2pup.this, settingPup.class));
                return true;
            case R.id.man:
