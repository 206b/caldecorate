...
import com.first.tripakey.caldecorate.decorate.curtains.Pleated.PleatdePagerAdapter;
import com.first.tripakey.caldecorate.main.SlidingTabLayout;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class Roman extends ActionBarActivity {
    ViewPager pager;
    RomanPagerAdapter adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[] = {"คำนวน", "ตั้งค่า"};
    int Numboftabs = 2;
    @Override
