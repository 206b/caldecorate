...
public class Manmon extends ActionBarActivity {
...
///////จบ1 copy แอดส่วนลดตาม
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.manmon);
        setContentView(R.layout.activity_manmon);
...
///////จบ2 copy แอดส่วนลดตาม
    ...
    public void onBackPressed() {
        startActivity(new Intent(Manmon.this, MainActivity.class));
        priceDoub=0;
                wFabDoub=0;
                weightDou=0;
                hand1Doub=0;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_manmon, menu);
        return true;
    }
    @Override
