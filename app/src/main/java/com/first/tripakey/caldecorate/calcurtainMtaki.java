...
public class calcurtainMtaki extends ActionBarActivity {
...
///////จบ2 copy แอดส่วนลดตาม
        ...
        setContentView(R.layout.activity_calcurtain_mtaki);
        ...
        txtV_nameCur = (TextView) findViewById(R.id.nameCurtain_txtV);
    ...
    public void onBackPressed() {
        startActivity(new Intent(calcurtainMtaki.this, curtain.class));
        double_fabW = 0.0;
        double_priceInt =0.0;
        double_doorW =0.0;
        double_doorH =0.0;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_settings:
                startActivity(new Intent(calcurtainMtaki.this, settingMtaki.class));
                return true;
            case R.id.man:
