...
public class mooliAlu extends ActionBarActivity {
...
///////จบ1 copy แอดส่วนลดตาม
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.mooli_alu);
        setContentView(R.layout.activity_mooli_alu);
...
//////เริ่ม3 copy แอดส่วนลดตาม
        ...
        final CheckBox c_motor = (CheckBox) findViewById(R.id.moterCheck);
        ...
        bt_cal.setOnClickListener(new View.OnClickListener() {
                                      ...
                                      public void onClick(View v) {
                                          if ((!WEdt.getText().toString().trim().isEmpty()) &&
                                              ...
                                              checkbox_motor = c_motor.isChecked();
...
*/
                                              ...
                                              if (checkbox_motor == true) {
                                                  if(!motorEdt.getText().toString().trim().isEmpty()){
                                                      motorDoub = Double.parseDouble(motorStr);
                                                  }  Toast.makeText(getApplicationContext(), "กรุณาใส่ราคามอเตอร์", Toast.LENGTH_LONG).show();
                                              }else motorDoub=0;

                                              totalBht= (totalSquare*priceHandDoub+motorDoub)*numlotDou ;
                                      ...
                                      public void onBackPressed() {
                                          startActivity(new Intent(mooliAlu.this, MainActivity.class));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_mooli_alu, menu);
        return true;
    }
    @Override
