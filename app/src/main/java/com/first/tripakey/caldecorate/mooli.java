...
public class mooli extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.mooli);
        setContentView(R.layout.activity_mooli);
...
*/
                                      ...
                                      public void onBackPressed() {
                                          startActivity(new Intent(mooli.this, MainActivity.class));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_mooli, menu);
        return true;
    }
    @Override
