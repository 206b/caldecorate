...
public class settingPup extends ActionBarActivity {
    //ตั้งตามสูตรต้อม
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.settingmp);
        setContentView(R.layout.activity_setting_pup);
     ...
     //   edt_J = (EditText) findViewById(R.id.setJ_edittext);
        ...
        noChe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.commit();
                startActivity(new Intent(settingPup.this, CalCurtain2pup.class));
            }
        });
                ...
                //    sD = edt_D.getText().toString();
                 ...
                 //   editor.putString("My_ValueD",  sD);
                  ...
                  //  editor.putString("My_ValueJ",  sJ);
                    ...
                    startActivity(new Intent(settingPup.this, CalCurtain2pup.class));//กลับไปหน้าคำนวน
                }
